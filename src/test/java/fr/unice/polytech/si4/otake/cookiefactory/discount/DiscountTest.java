...
public class DiscountTest {
    ...
    public void discrountElligibleProductsTest() {
        ...
        p.add(c);
        this.d1 = new Discount(false, 0.1, Discount.Trigger.code("CODE"), Discount.Behaviour.elligibleProducts(p));
        this.o = OrderStepBuilder.newOrder().addProduct(c, 5).validateBasket()
                .setAppointment(new SimpleDate("00-00-00 13:00")).withCode("CODE").WithoutAccount().validatePayment()
                .build(s);
