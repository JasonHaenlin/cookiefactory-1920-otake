...
public class DiscountTest {
        ...
        public void disountCodeTest() {
                ...
                this.o = OrderStepBuilder.newOrder().addProduct(Recipe.SOOCHOCOLATE.create()).validateBasket()
                                .setAppointment(new SimpleDate("00-00-00 13:00")).withCode("CODE").WithoutAccount()
                                .validatePayment().build(new Shop("city", "name", null));
                ...
                this.o = OrderStepBuilder.newOrder().addProduct(Recipe.SOOCHOCOLATE.create()).validateBasket()
                                .setAppointment(new SimpleDate("00-00-00 13:00")).withCode("NOPE").WithoutAccount()
                                .validatePayment().build(new Shop("city", "name", null));
                this.o.setPriceWithTaxes(10);
        ...
        public void discountHourTest() {
                ...
                this.o = OrderStepBuilder.newOrder().addProduct(Recipe.SOOCHOCOLATE.create()).validateBasket()
                                .setAppointment(new SimpleDate("00-00-00 19:00")).noCode().WithoutAccount()
        ...
        public void discrountElligibleProductsTest() {
                ...
                cs.add(c);
                this.d1 = new Discount(false, 0.1, Discount.Trigger.code("CODE"),
                                Discount.Behaviour.elligibleCookies(cs));
